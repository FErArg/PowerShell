...
$DirPath = 'C:\Users\frod006\OneDrive - Porsche Holding Salzburg\Logs\Avisos_Caducidad_Talleres_v2'
...
Se cominica al jefe de taller ($managerEmailFiltrado) para que le avise.
...
Para asistencia IT, utilice siempre el Formulario Contacto - https://bit.ly/3lTg7xS 
