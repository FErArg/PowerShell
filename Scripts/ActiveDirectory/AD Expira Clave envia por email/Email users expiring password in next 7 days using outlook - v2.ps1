...
$expireindays = 7
$FechaLog = get-date -format yyyy-MM-ddTHH-mm-ss-ff

#Program File Path
$LogFile = "C:\PS\PasswordExpiry" + "\" + $FechaLog + " " + "Log.txt"
...
$OUresp6 = 'fran.perez@levantewagen.es'
$OUpath7 = 'OU=PS222,OU=Levante,OU=Concesiones,DC=VGRS,DC=local'
$OUresp7 = 'daniel.deltejo@vwgroupretail.es'
...
#			$email.To = $emailaddress
			$email.Subject = "Aviso de Contraseña próxima a Caducar"
			$email.Body = "Buenas $Name,
			
	Tu clave de usuario/correo electrónico expira en $daystoexpire días.
